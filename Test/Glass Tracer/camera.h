...
class camera {
  public:
    ...
    void render(const hittable& world) {
        initialize();
            ...
            //Crea ofstream donde se almacena informacion del archivo de image (ppm) generado
        ...
        long long total_pixels = (long long)image_width * (long long)image_height;
        ...
        for (int j = 0; j < image_height; j++) {
            ...
            // Print progress: scanlines remaining and pixels done
            std::clog << "\rScanlines remaining: " << (image_height - j - 1)
                      << " | Pixels: " << pixels_done << " / " << total_pixels << std::flush;
        }
  ...
  private:
    ...
    void initialize() {
        ...
        //Establece el punto de origen de la camara
        center = lookfrom;

        // Determine viewport dimensions.
        
        //Calculos para considerar FOV (field of view) cambiante
    ...
    color ray_color(const ray& r, int depth, const hittable& world) const {
        // Verifica si se ha llegado al limite de rebotes de rayos de luz permitidos
        if (depth <= 0)
            return color(0,0,0);
